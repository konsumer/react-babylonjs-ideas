...
const saveStuff = async () => {
  ...
  await save(`${__dirname}/react-babylon/components.json`, classInfo)
  const tags = Object.keys(classInfo)
  await save(`${__dirname}/react-babylon/tags.json`, zipObject(tags, tags))
}
saveStuff()
